...
void ESP32FtmsBikeComponent::setup_characteristics() {
...
bool ESP32FtmsBikeComponent::check_identify_() {
  uint32_t now = millis();
...
void ESP32FtmsBikeComponent::set_state_(improv::State state) {
...
void ESP32FtmsBikeComponent::set_error_(improv::Error error) {
...
void ESP32FtmsBikeComponent::send_response_(std::vector<uint8_t> &response) {
...
void ESP32FtmsBikeComponent::process_incoming_data_() {
  ...
  if (this->incoming_data_.size() - 3 == length) {
    ...
    switch (command.command) {
      ...
      case improv::WIFI_SETTINGS: {
        ...
        auto f = std::bind(&ESP32FtmsBikeComponent::on_wifi_connect_timeout_, this);
...
void ESP32FtmsBikeComponent::on_wifi_connect_timeout_() {
