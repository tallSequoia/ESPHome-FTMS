...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.GenerateID(CONF_BLE_ID): cv.use_id(esp32_ble_server.BLEServer),  # cv.use_id(esp32_ftms_bike_ns.FTMSBike), # cv.use_id(esp32_ble_server.BLEServer), # cv.use_id(esp32_ble.ESP32BLE),
